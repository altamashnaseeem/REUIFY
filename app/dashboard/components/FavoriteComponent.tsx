  ...
  function favoriteComponentOpen(){
    ...
    return (
        <div className='grid grid-cols-4 gap-4 text-sm items-center rounded-lg p-2 max-sm:grid-cols-2 text-slate-200'>
            ...
            className={`${darkTheme?"text-slate-200":"text-slate-600"}  hover:text-sky-500 cursor-pointer`}>{component.name}</span>
            ...
            <div className='flex gap-2'>
             ...
             className={`${darkTheme?"bg-slate-100 text-gray-900 ":"bg-sky-500 hover:bg-sky-600"}  rounded-full w-7 h-7 flex items-center justify-center  cursor-pointer`}>
             <FaEdit fontSize="medium" className={`${darkTheme?"text-gray-900":"text-white"} text-[14px]`} />
             </motion.div>
             <motion.div whileHover={{scale:1.1}} 
             onClick={
              ()=>
             ...
             className={`${darkTheme?"bg-slate-100 text-gray-900":"bg-sky-500 hover:bg-sky-600"} rounded-full w-7 h-7 flex items-center justify-center  cursor-pointer`}>
             <MdDelete fontSize="medium" className={`${darkTheme?"text-gray-900":"text-white"} text-[15px]`} />
             </motion.div>
            </div>
        </div>
    )
